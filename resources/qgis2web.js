...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11765958.492314, 2146210.471106, -11300101.817634, 2601842.921828],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11523994.123608, 2367202.216743, -11520611.995326, 2369020.498554], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_DivisinmunicipaldeJalisco_4,
    colName: 'NOM_MUN',
    zoom: 10,
    collapsed: true,
    map: map,
